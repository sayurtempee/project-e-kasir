...
<body class="bg-[#3B82F6] min-h-screen grid grid-rows-[auto,1fr,auto]">
    ...
    <div class="ml-64 mt-16 p-8 font-sans">
        <div class="container mx-auto p-4">
            ...
            <div class="mb-4">
                <form action="<?php echo e(route('discount.index')); ?>" method="GET" class="flex items-center gap-2">
                    <input type="text" name="search" placeholder="Cari diskon..." value="<?php echo e(request('search')); ?>"
                    ...
                    <tbody>
                        <?php $__currentLoopData = $discounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b hover:bg-gray-100">
                                <td class="px-6 py-3"><?php echo e($discount->name); ?></td>
                                <td class="px-6 py-3"><?php echo e($discount->discount_percentage); ?>%</td>
                                <td class="px-6 py-3"><?php echo e($discount->valid_from); ?></td>
                                <td class="px-6 py-3"><?php echo e($discount->valid_until ?? '-'); ?></td>
                                <td class="px-6 py-3">
                                    <?php if($discount->valid_until && \Carbon\Carbon::parse($discount->valid_until)->isPast()): ?>
                                ...
                                <td class="px-6 py-3 flex space-x-4">
                                    ...
                                    <form action="<?php echo e(route('discount.destroy', $discount->id)); ?>" method="POST"
                                        onsubmit="return confirm('Apakah Anda yakin ingin menghapus diskon <?php echo e($discount->name); ?>');">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/e-kasir/resources/views/discount/daftar.blade.php ENDPATH**/ ?>