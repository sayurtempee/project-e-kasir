    ...
    <div class="max-w-5xl mx-auto bg-white p-6 shadow-md rounded-2xl">
            ...
            <tbody>
                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="px-6 py-3">
                            <button onclick="showBarcodeModal('<?php echo e($trx->product->id); ?>', '<?php echo e($trx->product->code); ?>')"
                                class="text-blue-600 font-bold hover:underline focus:outline-none">
                                <?php echo e($trx->product->code); ?>
        ...
        <div class="mt-4 flex justify-end">
            <div class="w-full max-w-sm bg-white p-4 rounded-xl shadow-md space-y-2">
                ...
                <?php if(isset($diskonPoin) && $diskonPoin > 0): ?>
                    <div class="flex justify-between text-sm text-gray-600">
                        <span class="font-semibold">Poin Digunakan:</span>
                        <span class="text-purple-700"><?php echo e($diskonPoin); ?> poin</span>
                    </div>
                    <div class="flex justify-between text-sm text-gray-600">
                        <span class="font-semibold">Diskon:</span>
                        <span class="text-purple-700"><?php echo e(number_format($diskonPersen, 0)); ?>%</span>
                    </div>
                    <div class="flex justify-between text-sm text-gray-600">
                        <span class="font-semibold">Potongan Harga:</span>
                        <span class="text-purple-700">
                            Rp<?php echo e(number_format(($cartTotal * $diskonPersen) / 100, 0, ',', '.')); ?>
                ...
                <div class="flex justify-between text-sm text-gray-600">
                    ...
                    <span class="text-green-700">Rp<?php echo e(number_format($grandTotal, 0, ',', '.')); ?></span>
                </div>
