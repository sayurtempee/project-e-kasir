                ...
                <form id="cartForm" action="<?php echo e(route('cart.bulkAction')); ?>" method="POST">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-3">
                                        <button
                                            onclick="showBarcodeModal('<?php echo e($cart->product->id); ?>', '<?php echo e($cart->product->code); ?>')"
                    ...
                    <div class="mt-8 mb-6 px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-end">
                        ...
                        <div>
                            ...
                            <?php if($diskonPoin): ?>
                                <p>Poin digunakan: <?php echo e($diskonPoin); ?> poin</p>
                                <p>Diskon: <?php echo e($diskonPersen); ?>%</p>
                                <p>Potongan: Rp<?php echo e(number_format(($cartTotal * $diskonPersen) / 100, 0, ',', '.')); ?></p>
                            <?php endif; ?>
